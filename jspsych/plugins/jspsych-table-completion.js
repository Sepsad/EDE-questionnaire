...
***/
    ...
    function add_columns(row_id, row_index){
      ...
      _.range(1,column_number).forEach(function(i){
        ...
        if(row_id=='final'){
          other_cols += '<td style=" text-align: left; width:'+base_width+'%"></td>';
        } else {
    ...
    function add_first_column(row_id, row_value, row_index, type){
      ...
      if(type=='old'){
        ...
        first_col += '<td class="'+class_string+'" id="row-'+row_id+'" style=" text-align: left; width:'+first_column_width+'%">'+row_value+'</td>';
      } else {
        first_col = '';
        first_col += '<tr style="width:100%">';
